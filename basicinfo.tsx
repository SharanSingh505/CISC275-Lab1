...
const yourName : String = "Sharanjit Singh";
let yourPronouns : String = "He/Him";
const yourMajor : String = "Computer Science- Data Science";
let classification : String = "Sophomore";
let oneExcite : String = "Learning TypeScript";
let anyConcerns : String = "I do not have any concerns";
let funFact : String = "I like to play basketball";
*/